...
- job 输入：`crux_repro/results/ablation/ablation_jobs.csv`
- baseline：`random_same`
- target：`crux_no_compress`
- job delta CSV：`crux_repro/results/ablation/job_analysis/crux_no_compress_vs_random_same_job_deltas.csv`
