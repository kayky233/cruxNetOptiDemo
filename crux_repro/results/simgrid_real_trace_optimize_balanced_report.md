...
- 输入结果：`crux_repro/results/simgrid_real_trace_optimize_balanced_results.csv`
- workload：`trace`
...
| `crux_no_compress` | 83.171 | 12.73% | 44.970 | 15.07% | 22.124 | 30.07% | 0.5374 |
| `crux` | 83.985 | 11.88% | 45.074 | 14.88% | 22.291 | 29.54% | 0.5322 |

## 结论

- 平均 JCT 最优的是 `crux_no_compress`，相对 baseline JCT 改善 15.07%。
- makespan 最优的是 `crux_no_compress`，相对 baseline makespan 改善 12.73%。
- 平均通信时间最优的是 `crux_no_compress`，相对 baseline comm 改善 30.07%。
